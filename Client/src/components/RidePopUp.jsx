...
export default function RidePopUp(props) {
    return (
        <div>
            <h5 className='absolute top-7 right-5 text-xl' onClick={() => { props.setRidePopUpPanel(false) }}><i className='ri-arrow-down-wide-line text-2xl'></i></h5>
            ...
            <div className='flex flex-col gap-2 items-center justify-between'>
                ...
                <div className='flex mt-2 w-full justify-evenly'>
                    <button onClick={() => { props.setRidePopUpPanel(false) }} className='bg-gray-300 text-gray-700 font-semibold p-3 px-8 rounded-lg'>Ignore</button>
                    <button onClick={() => { props.setConfirmRidePopUpPanel(true) , props.confirmRide() }} className='bg-green-600 text-white font-semibold p-3 px-8 rounded-lg'>Accept</button>
                </div>
            </div>
