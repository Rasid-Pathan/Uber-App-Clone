...
export default function FinishRide(props) {
  ...
  return (
    <div>
      <h5 className='absolute top-7 right-5 text-xl' onClick={() => { props.setFinishRidePanel(false) }}><i className='ri-arrow-down-wide-line text-2xl'></i></h5>
      <h3 className='text-2xl font-semibold mb-5'>Finish this Ride </h3>

      <div className='flex items-center justify-between mt-3 border-2 border-yellow-400 rounded-lg p-4'>
      ...
      <div className='flex flex-col gap-2 items-center justify-between'>
        ...
        <div className='mt-10 w-full'>
          <button onClick={endRide} className='bg-green-600 text-lg flex justify-center mt-5 w-full text-white font-semibold p-3 rounded-lg'>Finish Ride</button>
          {/* <p className='mt-10 text-center text-xs '>Click to finish ride button if you have completed this rid</p> */}
        </div>
      </div>
