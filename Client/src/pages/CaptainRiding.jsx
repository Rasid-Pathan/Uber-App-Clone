...
export default function CaptainRiding() {
  ...
  return (
    <div className='h-screen w-screen'>
      ...
      <div className='relative h-1/5 p-6 flex items-center justify-between bg-yellow-400' onClick={()=>{setFinishRidePanel(true)}}>
        <h5 className='absolute top-0 w-[90%] text-center p-1 text-xl' onClick={() => {  }}><i className='ri-arrow-up-wide-line text-3xl'></i></h5>
      ...
      //Finish Ride Panel
      <div ref={finishRidePanelRef} className='bg-white w-full fixed z-10 bottom-0 translate-y-full px-3 py-6'>
        <FinishRide
          ride={ride}
