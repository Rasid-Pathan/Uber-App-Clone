      ...
      <div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className='flex gap-4 mb-5'>
            <input className='bg-[#eeeeee] w-1/2 rounded px-2 py-2 border text-base placeholder:text-sm' type="text" value={firstname} onChange={(e) => { setFirstname(e.target.value) }} placeholder='Firstname' required />
            <input className='bg-[#eeeeee] w-1/2 rounded px-2 py-2 border text-base placeholder:text-sm' type="text" value={lastname} onChange={(e) => { setLastname(e.target.value) }} placeholder='Lastname' required />
          </div>

          <h3 className='text-base font-medium mb-2'>What's your email?</h3>
          <input className='bg-[#eeeeee] mb-5 rounded px-2 py-2 border w-full text-base placeholder:text-sm' type="email" value={email} onChange={(e) => { setEmail(e.target.value) }} placeholder='email@example.com' required />

          <h3 className='text-base font-medium mb-2'>Enter Password</h3>
          <input className='bg-[#eeeeee] mb-5 rounded px-2 py-2 border w-full text-base placeholder:text-sm' type="password" value={password} onChange={(e) => { setPassword(e.target.value) }} placeholder='password' required />

          <button className='bg-[#111] text-white font-semibold mb-7 rounded px-2 py-2 w-full text-lg'>Create account</button>
        </form>
