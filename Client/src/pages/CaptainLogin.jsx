...
export default function CaptainLogin() {
  ...
  return (
    ...
    <div className='p-7 h-screen flex flex-col justify-between'>
      ...
      <div> 
        <Link to='/login' className='bg-[#d5622d] text-white flex items-center justify-center font-semibold mb-5 rounded px-2 py-2 w-full text-lg'>Sign In as User</Link>
      </div>
    </div>
  )
}
